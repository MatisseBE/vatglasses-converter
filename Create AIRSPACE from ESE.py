...
with open('File With Sectors for AIRSPACE.txt',"r",encoding='utf-8') as f:
    # File like:
...
with open('File With Sectorlines for AIRSPACE.txt') as f:
    # File like:
    # SECTORLINE:572
...
with open('./Files/airspace.json', 'w') as outfile:
